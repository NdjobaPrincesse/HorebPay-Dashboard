    ...
    <div className="dashboard-container">
      ...
      <div className="stats-container">
        <div className="stat-card">
          ...
          <h3 className="stat-title" style={{marginLeft:'5rem'}}>USERS</h3><br/>
          <div className="stat-footer blue-bg">Total number of users</div>
        </div>
        ...
        <div className="stat-card">
          ...
          <h3 className="stat-title" style={{marginLeft:'5rem'}}>TRANSACTIONS</h3><br/>
          <div className="stat-footer orange-bg">Total amount received</div>
        </div>
        ...
        <div className="stat-card">
          <div className="stat-card-header">
            ...
            <span className="stat-number">{formatCurrency(stats.earnings)}</span>
          </div>
          <h3 className="stat-title" style={{marginLeft:'5rem'}}>ALL EARNINGS</h3><br/>
          <div className="stat-footer green-bg">Total amount received</div>
        </div>
      </div><br/>
