...
const toneStyles = {
  danger: {
    ...
    glow: 'from-red-500/15 via-rose-500/10 to-transparent',
  ...
  success: {
    ...
    glow: 'from-emerald-400/15 via-green-400/10 to-transparent',
    badge: 'bg-emerald-50 text-emerald-700 border-emerald-100',
    confirm: 'bg-emerald-600 hover:bg-emerald-700 shadow-emerald-500/20',
  },
  primary: {
    panel: 'border-blue-100',
    glow: 'from-blue-500/15 via-cyan-400/10 to-transparent',
      ...
      <div className={`relative w-full max-w-md overflow-hidden rounded-[2rem] border bg-white shadow-[0_30px_80px_rgba(15,23,42,0.18)] ${styles.panel}`}>
        ...
        <div className="relative flex items-start justify-between gap-4 px-6 pt-6">
          <div className="flex items-start gap-4">
            <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border ${styles.badge}`}>
        ...
        <div className="px-6 pb-6 pt-5">
          <div className="rounded-2xl border border-slate-100 bg-slate-50/80 px-4 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">
            Please confirm this action before continuing
          </div>
        </div>

        <div className="flex gap-3 border-t border-slate-100 bg-slate-50/80 px-6 py-5">
          <button 
            onClick={onClose}
            disabled={isLoading}
